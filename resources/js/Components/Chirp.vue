        ...
        <div class="flex-1">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <small v-if="chirp.created_at != chirp.updated_at" class="ml-2 text-sm text-gray-600">&middot; Edited</small>
                </div>
            ...
            <form v-if="editing" @submit.prevent="form.put(route('chirps.update', chirp.id), { onSuccess: () => editing = false })">
                ...
                <InputError :message="form.hasErrors.message" class="mt-2"></InputError>
                <div class="space-x-2">
